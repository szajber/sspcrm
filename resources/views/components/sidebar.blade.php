    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
        <nav class="flex-1 px-2 py-4 space-y-1">
            ...
            @if (Auth::user()->role === \App\Enums\UserRole::Admin)
                ...
                <a href="{{ route('settings.door-resistance-classes.index') }}" class="{{ request()->routeIs('settings.door-resistance-classes.*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md pl-11">
                    {{ __('Klasy drzwi') }}
                </a>

                <a href="{{ route('settings.fire-damper-types.index') }}" class="{{ request()->routeIs('settings.fire-damper-types.*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md pl-11">
                    {{ __('Klapy') }}
                </a>

                <a href="{{ route('settings.smoke-extraction-central-types.index') }}" class="{{ request()->routeIs('settings.smoke-extraction-central-types.*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md pl-11">
                    {{ __('Oddymianie') }}
                </a>
